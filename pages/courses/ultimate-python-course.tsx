...
const IntroToPython: React.FC = () => {
    ...
    return (
        <>
            <Head>
                <title>Ultimate Python Course</title>
            </Head>
            <CourseHeader
                name='Ultimate Python Course'
                ...
                prerequisites={[]}
                courseUrl="https://sso.teachable.com/secure/1909862/checkout/5228722/ultimate-python-course-zero-to-hero"
            />
        </>
    );
};
